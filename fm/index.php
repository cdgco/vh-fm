...
<html lang="en">
    ...
    <head>
        ...
        <title><?php echo $sitetitle; ?> - <?php echo __("File Manager"); ?></title>
    ...
    <body class="fix-header">
            ...
            <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title"><?php echo _("File Manager Login"); ?></h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="white-box">
                                <form class="form-horizontal form-material" autocomplete="off" action="launch.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="password" class="form-control form-control-line" autocomplete="password" name="password" id="password">                                   
                                    </div>
                                </div>
				<input type="hidden" style="display:none" name="server" value="<?php echo HESTIA_HOST_ADDRESS; ?>">
                                <div class="form-group">
                                    <div class="col-sm-12">
	    ...
	    if(isset($_GET['error']) && $_GET['error'] == "1") {
                echo "Swal.fire({title:'Credentials Error', html:'" . __("Please check your login information and try again.") . "', icon:'error'});";
            }
	    ?>
        </script>
    </body>
